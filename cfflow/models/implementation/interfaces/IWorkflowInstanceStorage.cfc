interface {
	...
	public void    function recordAction( required string workflowId, required struct instanceArgs, required struct state, string stepId, required string actionId, required string resultId, required array transitions, required array priorStepStatuses );
}